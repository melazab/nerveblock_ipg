...
#define MAX_SIZE_SERVER_TX 256
#define MAX_SIZE_SERVER_RX 256
...
#if ( BLE_CFG_OTA_REBOOT_CHAR != 0 )
#    if ( UUID_128_SUPPORTED == 1 )
static const uint8_t BM_REQ_CHAR_UUID[ 16 ] = { 0x19, 0xed, 0x82, 0xae, 0xed, 0x21, 0x4c, 0x9d,
                                                0x41, 0x45, 0x22, 0x8e, 0x11, 0xFE, 0x00, 0x00 };
#    else
 ...
 */
#define COPY_P2P_SERVICE_UUID( uuid_struct )                                                       \
    COPY_UUID_128( uuid_struct,                                                                    \
                   ...
                   0xe5,                                                                           \
                   0x8f )
#define COPY_P2P_WRITE_CHAR_UUID( uuid_struct )                                                    \
    COPY_UUID_128( uuid_struct,                                                                    \
                   0x00,                                                                           \
                   0x00,                                                                           \
                   0xfe,                                                                           \
                   ...
                   0xed,                                                                           \
                   0x19 )
#define COPY_P2P_NOTIFY_UUID( uuid_struct )                                                        \
    COPY_UUID_128( uuid_struct,                                                                    \
                   0x00,                                                                           \
                   0x00,                                                                           \
                   0xfe,                                                                           \
...
void P2PS_STM_Init( void )
{
    ...
    aci_gatt_add_char( aPeerToPeerContext.PeerToPeerSvcHdle,
                       ...
                       ATTR_PERMISSION_NONE,
                       GATT_NOTIFY_ATTRIBUTE_WRITE | GATT_NOTIFY_WRITE_REQ_AND_WAIT_FOR_APPL_RESP | GATT_NOTIFY_READ_REQ_AND_WAIT_FOR_APPL_RESP, /* gattEvtMask */
                       10,                          /* encryKeySize */
                       CHAR_VALUE_LEN_VARIABLE,     /* isVariable: 1 */
 ...
 *
 */
tBleStatus P2PS_STM_App_Update_Char( uint16_t UUID, uint8_t Length, uint8_t* pPayload )
{
