...
void MX_DMA_Init(void)
{
	/* DMA controller clock enable */
	  ...
	  HAL_NVIC_SetPriority(DMA1_Channel5_IRQn, 14, 0);		// lpuart_tx
	  HAL_NVIC_EnableIRQ(DMA1_Channel5_IRQn);

	  HAL_NVIC_SetPriority(DMA1_Channel3_IRQn, 14, 0);		// uart_rx
	  HAL_NVIC_EnableIRQ(DMA1_Channel3_IRQn);

	  HAL_NVIC_SetPriority(DMA1_Channel4_IRQn, 14, 0);		// uart_tx
